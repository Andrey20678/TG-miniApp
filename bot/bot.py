...
wh_url = f"https://{bs.web_hook}/whma"
...
reply = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=bs.button_text, web_app=WebAppInfo(url=f"https://{bs.button_url}"))]])
